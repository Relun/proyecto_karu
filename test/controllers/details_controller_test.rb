...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { price: @detail.price, quantity: @detail.quantity } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { price: @detail.price, quantity: @detail.quantity } }
